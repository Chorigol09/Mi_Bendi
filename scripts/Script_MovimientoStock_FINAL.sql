...
-- =============================================
-- Script FINAL para MOVIMIENTO_STOCK
-- =============================================

-- Verificar si la columna Stock existe en PRODUCTO_TIENDA
...
PRINT 'Procedimiento usp_ObtenerMovimientosStock creado exitosamente.'
GO
...
PRINT 'Procedimiento usp_RegistrarMovimientoStock creado exitosamente.'
GO
...
PRINT '- El stock se maneja en PRODUCTO_TIENDA'
PRINT ''
